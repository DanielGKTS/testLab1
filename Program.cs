...
Console.WriteLine("Daniel Kim");
Console.WriteLine("Version: {0}", Environment.Version.ToString());

//Completed 1/27/3023

/*
 * Task 2 was completed by Daniel Kim 
 */
...
string[] names2 = new[] { "Daniel", "Kim", "Bob", "Rob" };
...
{
  { "Creeper", "Witch", "Skeleton", "Piglin" },
  { "Cat", "Villager", "Zombie", "Hoglin" },
  { "One", "Two", "Three", "Four" }
};
...
grid2[0, 0] = "Wolf"; // assign string values
// and so on
grid2[2, 3] = "Jaguar";
